...
c.content.headers.user_agent = "Mozilla/5.0 ({os_info}) AppleWebKit/{webkit_version} (KHTML, like Gecko) Chrome/{upstream_browser_version_short} Safari/{webkit_version}"
