...
alias ask="llm -m claude-3.5-sonnet -s \"Only provide essential information. Follow up questions may be asked if necessary. Don't provide superfluous detail initially\""
...
alias commit2clip="git diff --staged | llm -m 4o -s \"Create a brief git commit message from this diff. Focus on major changes and feel free to broadly generalize or even ignore a variety of smaller changes. Provide only the commit message.\" | tee /dev/tty | 2clip"
